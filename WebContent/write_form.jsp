				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<form class="form-horizontal" action="" method="post">
							<fieldset>
								<legend class="text-center" style="margin-top: 10px">Day 1</legend>
								<!-- Name input-->
								...
								<!-- Email input-->
								<div class="form-group">
									<label class="col-md-3 control-label" for="email">장소</label>
									<div class="col-md-9">
										<input id="place" name="place" type="text"
											placeholder="장소를 선택하세요" class="form-control">
									</div>
								</div>
